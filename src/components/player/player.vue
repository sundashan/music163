<template>
  <div class="player" v-show="showPlayer" ref="player">
  	<div class="normal-palyer">
        ...
        <div class="lyric">{{player.data}}</div>
  		</div>
  		<div class="bottom">
        <audio :src="`http://ws.stream.qqmusic.qq.com/${player.data.songid}.m4a?fromtag=46`" @paly="ready" autoplay="autoplay" controls="controls"></audio>
  		</div>
  	</div>
